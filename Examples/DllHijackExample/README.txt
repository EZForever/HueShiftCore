This example shows how to use the delay-load hook module (delayhook.hpp) to automatically generate DLL hijack stubs, removing the need of an Injector.
...
- Delay-load hook provided by delayhook.hpp replaces references to target DLL in delay-load stub at run-time
...
NOTE: A lot of settings need to be configured properly for this example to build and function. See config.h, exports.def and Directory.Build.props for details.
